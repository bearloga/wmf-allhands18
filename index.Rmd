...
```{r dt, dependson='nba_data', eval=FALSE}
message("This is where the interactive NBA data table should be.")
DT::datatable(
  nba,
  options = list(
    order = list(1, "desc")
