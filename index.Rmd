...
This can be done in pairs or individually. You have 5 minutes to pick one of the following 3 visualizations, note 2-3 interesting observations from your pick, and share those insights with your neighbors at the table.

**Remember**, once you've identified the variables involved, you are looking for relationships between them. You're also looking for patterns, outliers, and anything unusual.
...
par(mfrow = c(1, 1))
```
```{r plot2, fig.width=10, fig.height=10, out.width=624}
waffle::iron(
  waffle::waffle(
...
quiz(
  question(
    "Which of these is an example of a discrete quantitative variable?",
    ...
    incorrect = "Time spent is continuous and user session ID is a qualitative variable."
  ),
  question(
    "Which basic chart is the best type for two continuous quantitative variables?",
    answer("pie"),
    answer("bar"),
